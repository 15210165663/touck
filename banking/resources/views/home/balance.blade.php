				...
				<div class="row">
					<div class="eight columns">
						<div class="caption-container-main m-bot-30">
							...
							<ul id="toggle-view">
								<li>
									<h3 class="ui-accordion-header ui-accordion-header-active">
									...
									<h5>
									<a href="{{url('project/balance')}}" style="color:green">点击充值</a>
									</h5>
									<p></p>
									</div>
								</li>
								...
								<li>
									<h3 class="ui-accordion-header"><span class="link"></span>预约列表</h3>
									<div class="panel">
										<p>
					...
					<div class="eight columns">
						<div class="caption-container-main m-bot-30">
							<div class="caption-text-container">充值余额</div>
							<div class="content-container-white caption-bg "></div>
						</div>
						<div id="skill-bars">
						<form action="{{url('project/balanceadd')}}" method="post">
							<input type="text" style="width:320px" name="price"><button style="height: 42px;width:100px">充值</button>
						</form>
						</div>
					</div>
				</div>
