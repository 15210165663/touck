...
<style>
    h2{font-weight:blod;font-size:20px;text-align: center;}
...
<div class="mar m-pager-box1" board="all">
           ...
           <div class="mt30 clearfix">
                <div class="data-line" style="margin-bottom: 15px;">
                    ...
                    <br>
                    <center>
                    <span class="red" style="font-size:28px;">{!!$title!!}</span>
                    <br>
                    <br>
                    <span>{!!$time!!}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <span>来源：{!!$source!!}</span><br><br><hr>
                    </center>
                    <div style="width:60%;font-size:15px;margin-left:22%;line-height:40px;">
                        {!!$content!!}
                    </div>
            </div>
        </div>
...
<!-- <p>
<a href="{{url('project/show')}}" >首页</a> > <a href="{{url('project/meigu')}}" >美股频道</a> > <a href="" >美股新闻</a> > 正文
</p> -->
</div>
<!-- <div class="titmain">
    <h1>{{$title}}</h1>
