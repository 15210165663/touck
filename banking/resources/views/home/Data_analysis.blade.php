...
<body class="reversedColor">
	...
	<div class="content">
		<p class="top_title1"><span><a href="http://q.10jqka.com.cn/usa/">美国市场</a>></span>数据分析</p>
			...
			<table class="m-table m-pager-table">
				<thead>
					<tr>
						...
						<th style="width:10%" ><a href="javascript:void(0)" field="stockcode" >代码<i></i></a></th>
					    <th style="width:11%" ><a href="javascript:void(0)" field="stockname" >简称<i></i></a></th>						
						<th style="width:10%" ><a href="javascript:void(0)" field="xj" >业绩报告类型<i></i></a></th>
						<th style="width:16%"  class="cur"><a href="javascript:void(0)" field="zdf" order="desc"  class="desc">业绩预告摘要<i></i></a></th>
                        
                        <th style="width:10%" ><a href="javascript:void(0)" field="hs" >净利润变动幅度<i></i></a></th>
                        <th style="width:10%" ><a href="javascript:void(0)" field="cjl" >上年同期净利润<i></i></a></th>
					    <th style="width:10%" ><a href="javascript:void(0)" field="syl" >公告日期<i></i></a></th>
                ...
                <tbody>
					...
					<?php foreach ($add_list as $key => $value) {?>
                           ...
                           <tr>
	                		<td>{{$value->analysis_id}}</td>
	                		<td><a href="http://stockpage.10jqka.com.cn/KNX/" target="_blank">{{$value->analysis_code}}</a></td>
	                		<td><a href="http://stockpage.10jqka.com.cn/KNX/" target="_blank">{{$value->analysis_abbreviation}}</a></td>
	                		<td class="c-fall">{{$value->analysis_Trailer}}</td>
	                		<td class="c-fall">{{$value->analysis_abstract}}</td>
	                		<td class="c-fall">{{$value->analysis_Range}}</td>
	                		<td>{{$value->analysis_profit}}</td>
	                		<td>{{$value->analysis_Date}}</td>
