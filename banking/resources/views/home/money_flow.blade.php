...
<head>
	<meta charset="GBK">
	<title>全部美股涨跌排行榜_同花顺行情中心_同花顺财经网</title>
    ...
    <meta name="description" content="核新同花顺网络信息股份有限公司（同花顺）成立于1995年，是一家专业的互联网金融数据服务商，为您全方位提供财经资讯及全球金融市场行情，覆盖股票、基金、期货、外汇、债券、银行、黄金等多种面向个人和企业的服务。"/>
        <link rel="stylesheet" href="http://s.thsi.cn/cb?css/q/;reset.css;common.css&20161130"/>
                    <link rel="stylesheet" href="http://s.thsi.cn/cb?css/q/;meiganggu.css&20161130">  
...
<body class="reversedColor">
    ...
    <div class="w1200">
        ...
        <div class="nav">
            ...
            <a href="http://q.10jqka.com.cn/gn/" data-type="bk" class="arr-trigger ">板块</a>
        ...
        <div class="sub-nav" data-type="bk" style="display: none;">
            ...
            <ul class="channel clearfix">
                ...
                <li ><a href="http://q.10jqka.com.cn/thshy/" target="_blank">同花顺行业</a></li>
	...
	<div class="content">
		...
		<p class="check">颜色配置：<input type="radio" name="red_green" checked="checked" id="red_check">红涨绿跌<input type="radio" name="red_green" id="green_check">绿涨红跌</p>	
		...
		<div id="maincont"  data-fixedthead="true">   
			...
			<table class="m-table m-pager-table">
				<thead>
					<tr>
						...
						<th style="width:4%" ><a href="javascript:void(0)" field="stockcode" >代码<i></i></a></th>
					    <th style="width:11%" ><a href="javascript:void(0)" field="stockname" >简称<i></i></a></th>						
						<th style="width:5%" ><a href="javascript:void(0)" field="xj" >现价<i></i></a></th>
						<th style="width:6%"  class="cur"><a href="javascript:void(0)" field="zdf" order="desc"  class="desc">涨跌幅<i></i></a></th>
                        
                        <th style="width:5%" ><a href="javascript:void(0)" field="hs" >换手率<i></i></a></th>
                        <th style="width:6%" ><a href="javascript:void(0)" field="cjl" >流入资金<i></i></a></th>
					    <th style="width:6%" ><a href="javascript:void(0)" field="syl" >流出资金<i></i></a></th>
					    <th style="width:6%" ><a href="javascript:void(0)" field="cje" >净额<i></i></a></th>
	                    <th style="width:6%" ><a href="javascript:void(0)" field="52zg" >成交额<i></i></a></th>
	                    <th style="width:6%" ><a href="javascript:void(0)" field="52zg" >大单流入<i></i></a></th>
                        
                </thead>
                <tbody>

					<?php foreach ($add_list as $key => $value) {?>
					
                           <tr>
	                		<td>{{$value->moneyflow_id}}</td>
	                		<td><a href="http://stockpage.10jqka.com.cn/KNX/" target="_blank">{{$value->moneyflow_code}}</a></td>
	                		<td><a href="http://stockpage.10jqka.com.cn/KNX/" target="_blank">{{$value->moneyflow_abbreviation}}</a></td>
	                		<td class="c-fall">{{$value->moneyflow_lateprice}}</td>
	                		<td class="c-fall">{{$value->moneyflow_fluct}}</td>
	                		<td class="c-fall">{{$value->moneyflow_rate}}</td>
	                		<td>{{$value->moneyflow_funds}}</td>
	                		<td>{{$value->moneyflow_outfunds}}</td>
	                		<td>{{$value->moneyflow_net}}</td>
	                		<td>{{$value->moneyflow_turnover}}</td>
	                		<td>{{$value->moneyflow_inflow}}</td>
           ...
           <a class="cur" page="1" href="javascript:void(0)">{!! $add_list->render()!!}</a>
     	    ...
     	    <div class="cf">
	    		...
	    		<ul>
	    			    			<li><a href="http://news.10jqka.com.cn/20170913/c600426759.shtml" target="_blank" title="机构预计苹果今年销量将达2.275亿部 累计营收明年年底有望达1万亿">机构预计苹果今年销量将达2.275亿部...</a><span class="right_date">2017-09-13</span></li>
