...
<div class="content-1200">
            ...
            <div class="mt30 clearfix">
                <div class="data-line" style="margin-bottom: 15px;">
                    <p><a href="{{url('project/show')}}" style="color:black;">首页</a> > <a href="{{url('project/meigu')}}" style="color:black;">美股频道</a> > <a href="{{url('project/meigu_newpage')}}?type={{$type}}" style="color:black;">
                        @if($type=='mgyw')
                        美股要闻
                        @elseif($type=='zggng')
                        中国概念股
            ...
            <ul>
                @foreach($jrj_new_rows as $k => $v)
                <li>
                    <span class="arc-title">
                      <a target="_blank" title="{{$v['title']}}" href="{{url('project/meigu_new')}}?link={{$v['link']}}&type={{$type}}">{{$v['title']}}</a>
                        <span>{{$v['time']}}</span>
                    </span>
                    <a target="_blank" href="{{url('project/meigu_new')}}?link={{$v['link']}}&type={{$type}}"  rel="nofollow" class="arc-cont">{{$v['content']}}</a>
                </li>
                @endforeach
            </ul>
<div class="bottom-page">
    <span class="num-container">
        ...
        @for($i=1;$i<=10;$i++)
            ...
            @else
                @if($i==1)
                <a href="{{url('project/meigu_newpage')}}?page={{$i}}&link=http://usstock.jrj.com.cn/list/{{$type}}.shtml&type={{$type}}" rel="nofollow">{{$i}}</a>
                @else
                <a href="{{url('project/meigu_newpage')}}?page={{$i}}&link=http://usstock.jrj.com.cn/list/{{$type}}-{{$i}}.shtml&type={{$type}}" rel="nofollow">{{$i}}</a>
                @endif
            @endif
        @endfor          
    </span>
