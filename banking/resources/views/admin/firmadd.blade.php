    ...
    <div id="pd_add_form" class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="form-group">
          <label class="col-sm-2 control-label" for="firstname">企业用户名</label>
          <div class="col-sm-5">
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label" for="firstname">企业密码</label>
          <div class="col-sm-5">
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label" for="firstname">企业名称</label>
          <div class="col-sm-5">
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label" for="firstname">企业负责人</label>
          <div class="col-sm-5">
            <input class="form-control valid" type="text">
          </div>
          <div class="col-sm-5 col-msg"><span class="field-validation-valid"></span></div>
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label" for="firstname">联系方式</label>
          <div class="col-sm-5">
            <input class="form-control valid" type="text">
          </div>
          <div class="col-sm-5 col-msg"><span class="field-validation-valid"></span></div>
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label" for="firstname">企业邮箱</label>
          <div class="col-sm-5">
            <input class="form-control valid" type="text">
          </div>
          <div class="col-sm-5 col-msg"><span class="field-validation-valid"></span></div>
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label" for="firstname">企业地址</label>
          <div class="col-sm-5">
            <input class="form-control valid" type="text">
          </div>
          <div class="col-sm-5 col-msg"><span class="field-validation-valid"></span></div>
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label" for="firstname">企业状态</label>
          <div class="col-sm-5">
            通过<input type="radio" value="1">&nbsp;&nbsp;不通过<input type="radio" value="0">
