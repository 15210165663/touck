...
<div class="dashboard-container">
  <div class="col-lg-4 col-md-4 col-md-offset-4">
    ...
    <div class="sign-in-container">
      <form action="<?php echo e(URL('/admin/loginin')); ?>" method="post" class="login-wrapper">
        <div class="header">
          <div class="row">
            <div class="col-md-12 col-lg-12">
              <h3>后台登录<img src="images/logo1.png" alt="Gold International" class="pull-right"></h3>
        ...
        <div class="content">
          ...
          <div class="form-group">
            ...
            <span class="field-validation-valid"></span>
            <input class="form-control" maxlength="20" name="password" placeholder="密码" type="password">
          </div>
          <!-- <div class="form-group">
            ...
            <div>
              <div class="col-md-4" style="padding-left:0">
                <input class="form-control" placeholder="验证码" type="text" value="">
              </div>
              <div class="col-md-8"><img src="images/index.png" alt="" height="34" class="code_img" >&nbsp;&nbsp;<a href="#">看不清楚？</a></div>
            </div>
          </div> -->
          <div class="actions">
            <input class="btn btn-success" name="Login" type="submit" value="登录">
            <a href="#" class="link">忘记密码?</a>
            <a href="<?php echo e(URL('/admin/register')); ?>" class="link">注册</a>
