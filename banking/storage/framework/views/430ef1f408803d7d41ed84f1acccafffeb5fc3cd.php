	...
	<div class="sixteen columns">
			...
			<nav id="main-nav">
				<ul class="sf-menu clearfix">
					...
					<li><a href="<?php echo e(url('project/portfolio')); ?>"><font color="red">股票列表</font></a></li>
					<li><a href="<?php echo e(url('project/blog')); ?>"><font color="red">持股大师</font></a></li>
					<li class="current"><a href="<?php echo e(url('project/contact')); ?>"><font color="red">评论</font></a></li>
